...
void main() {
  group('LeaderboardEntryModel.fromJson', () {
    ...
    test(
      'a null display_name falls back to a placeholder, not an empty string',
      () {
        final entry = LeaderboardEntryModel.fromJson({
          'display_name': null,
          'rank': 4,
    ...
    test(
      'score parses whether Postgres sends it as a number or a numeric string',
      () {
        final fromNum = LeaderboardEntryModel.fromJson({
          'display_name': 'A',
          'rank': 1,
          'score': 12.5,
        });
        final fromString = LeaderboardEntryModel.fromJson({
          'display_name': 'A',
          'rank': 1,
          'score': '12.5',
        });
