...
void main() {
  group('ChallengeCard state branching', () {
    testWidgets('guest sees the sign-in prompt, not a progress bar', (
      tester,
    ) async {
    ...
    testWidgets('draft challenge shows the not-visible copy, no prompt/bar', (
      tester,
    ) async {
    ...
    testWidgets('signed-in at Bronze → progress toward Silver + a tier badge', (
      tester,
    ) async {
      await _pump(
        tester,
    ...
    testWidgets('platinum shows the max-tier state, not another bar', (
      tester,
    ) async {
      await _pump(
        tester,
  ...
  group('ChallengeCard — calm migration (Phase 12)', () {
    ...
    testWidgets('points/participant count are opt-in, off by default', (
      tester,
    ) async {
